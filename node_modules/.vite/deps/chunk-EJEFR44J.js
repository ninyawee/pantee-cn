...
function Code($$anchor, $$props) {
  ...
  add_svelte_meta(
    () => (
      ...
      *
      */
      Icon_default(node, spread_props({ name: "code" }, () => props, {
        get iconNode() {
          return iconNode;
        },
        children: wrap_snippet(Code, ($$anchor2, $$slotProps) => {
          ...
          add_svelte_meta(() => snippet(node_1, () => $$props.children ?? noop), "render", Code, 62, 2);
...
//# sourceMappingURL=chunk-EJEFR44J.js.map
