import { a as attributes, f as clsx$1, c as bind_props, k as ensure_array_like, ae as element, s as spread_props } from "./index2.js";
...
const docsNavigation = [
  {
    title: "Basics",
    items: [
      { title: "Getting Started", href: "/docs", icon: Book_open },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Markers", href: "/docs/markers", icon: Map_pin },
      { title: "Popups", href: "/docs/popups", icon: Message_square },
...
const fullNavItems = docsNavigation.flatMap((group) => group.items);
function findNeighbors(pathName) {
