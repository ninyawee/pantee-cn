...
type RouteParams = {  };
type RouteId = '/docs/advanced-usage';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/docs/advanced-usage/+page.server.js').load>>>>>>;
